...
var files = process.argv.slice(2);
        // read env vars here?  parse command line arguments?
        //["test/bluetooth_log-2014-07-28-21\:00\:00.048" //bit file1210 records
        // ,"test/bluetoothdump" // small file, 50 records
        //]

if(files === undefined || files.length===0) {
    console.log('a list of files is required as a command line argument')
    console.log(process.argv.join(' ') + ' file1 file2 file3 morefiles* ')
    process.exit(1)
}
