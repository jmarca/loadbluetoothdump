...
function create_perlhash_statement(table){
    return "CREATE TEMP TABLE perlxml (data string)"
}
function copy_perlhash_statement(table){
    return "COPY perlxml (data) FROM STDIN WITH CSV "
}
