...
function bt_parser(reader,writer){
    ...
    this.perl_parser=function(client){
        // essentially, I have to do these in order:

//insert into smartsig.bt_xml_project  (select distinct * from smartsig.perl_xml_project_decoder_from_location()) ;

//insert into smartsig.bt_xml_location  (select distinct * from smartsig.perl_xml_location_decoder_from_location()) ;

//insert into smartsig.bt_xml_segment  (select distinct * from smartsig.perl_xml_segment_decoder()) ;

//insert into smartsig.bt_xml_observation  (select  * from smartsig.perl_xml_segment_obs_decoder()) ;
